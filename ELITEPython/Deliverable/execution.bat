...
python %file1% %mode% %historical_down_periods_file% %failure_rate_file% %product_related_characteristics_file% %energy_price_file% %job_info_file% %scenario% %objective% %pop_size% %generations% %crossover_rate% %mutation_rate%
