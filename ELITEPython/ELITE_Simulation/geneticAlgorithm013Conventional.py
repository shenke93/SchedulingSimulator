'''Version 0.1.3 conventional used for paper
Features: 1. Add memory features: memory is an empty list without limited size (Remove)
          2. Change mutation process
          3. Reuse all inputs of version 0.1.2, output in the new file
          4. Make unit production cost static
          5. Add distance calculation (Remove)
